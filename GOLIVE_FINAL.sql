...
LOCK TABLES `ad_placements` WRITE;
/*!40000 ALTER TABLE `ad_placements` DISABLE KEYS */;
/*!40000 ALTER TABLE `ad_placements` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ai_recommendations_cache`
--

LOCK TABLES `ai_recommendations_cache` WRITE;
/*!40000 ALTER TABLE `ai_recommendations_cache` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ai_recommendations_cache` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `backup_products` WRITE;
/*!40000 ALTER TABLE `backup_products` DISABLE KEYS */;
/*!40000 ALTER TABLE `backup_products` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `profile_edit_requests` WRITE;
/*!40000 ALTER TABLE `profile_edit_requests` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `profile_edit_requests` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-29 18:06:57
